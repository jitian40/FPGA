...
//altfp_abs CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=1 WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock data result
...
module abs (
	...
	abs_altfp_abs_adb	abs_altfp_abs_adb_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.data (data),
